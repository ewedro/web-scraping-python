...
page = "http://dataquestio.github.io/web-scraping-pages/simple.html"
...
all_outer = parser.select(".outer-text")
first_outer_text = all_outer[0].text

all_id = parser.select("#second")
second_text = all_id[0].text
